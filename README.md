...
> **Architecture:** see [ARCHITECTURE.md](./ARCHITECTURE.md) for request flows, folder map, and interview talking points.
...
└── my-react-app/      # React SPA
    └── src/
        ├── pages/     # Home, Login, Signup, Dashboard, history pages
        ├── components/
        └── hooks/
```
